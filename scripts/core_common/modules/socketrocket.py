...
# Build for iphone
  ...
  base.cmd("lipo", ["build/Release/libSocketRocket.a", "-thin", "x86_64", "-output", os.path.join(mac_64_lib_dir, "libSoсketRocket.a")])
  base.cmd("lipo", ["build/Release/libSocketRocket.a", "-thin", "arm64", "-output", os.path.join(mac_arm64_lib_dir, "libSoсketRocket.a")])
